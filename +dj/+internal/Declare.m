        ...
        function [sql, external_stores] = declare(table_instance, def)
            ...
            switch true
                ...
                case {isa(table_instance, 'dj.internal.UserRelation'), isa(table_instance, ...
                    ...
                    if isa(table_instance, 'dj.Part')         
                        if contains(table_instance.master.plainTableName,table_instance.schema.prefix)
                            masterName = extractAfter(table_instance.master.plainTableName,table_instance.schema.prefix);
                        else
                            masterName = table_instance.master.plainTableName;
                        end
